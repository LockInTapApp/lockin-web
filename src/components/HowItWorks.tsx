import { Smartphone, Hand, Lock, type LucideIcon } from "lucide-react";
...
type Step = { n: string; icon: LucideIcon; title: string; body: string; testId: string };
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline gap-3">
                        <span className="font-display text-xs text-neutral-400 tracking-[0.2em]">{s.n}</span>
