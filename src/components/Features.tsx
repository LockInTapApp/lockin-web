        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
          ...
          >
            <div className="flex items-center gap-3 mb-5 relative z-10">
              ...
              <span className="text-xs uppercase tracking-[0.22em] text-white/75">Bricking</span>
            </div>
            ...
            <p className="mt-3 text-white/80 max-w-lg relative z-10">
              Curate apps and websites that disappear the moment your phone touches the brick.
              Notifications go silent. The theme flips dark. A stopwatch starts counting your time
              saved.
            </p>
            ...
            <div className="mt-6 inline-flex items-center gap-4 px-5 py-3 rounded-2xl bg-black/25 border border-white/20 relative z-10">
              ...
              <div className="font-display text-2xl tracking-tighter">01:42:08</div>
              <span className="text-xs uppercase tracking-[0.2em] text-white/70">Locked in</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-display text-2xl font-medium">Silenced notifications</h3>
            <p className="mt-2 text-white/60 text-sm">
              Every blocked app&apos;s notifications are intercepted. View them later in one tidy log.
            </p>
          ...
          >
            ...
            <div className="mt-5 space-y-2 text-sm">
              <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-white/[0.04] border border-white/5">
                ...
                <span className="text-white/40 text-xs">Mon–Fri · 9–12</span>
              </div>
              <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-white/[0.04] border border-white/5">
          ...
          >
            <div className="grid md:grid-cols-2 gap-6 items-center">
              <div>
                ...
                <h3 className="font-display text-2xl md:text-3xl font-medium">Wake up with a tap.</h3>
                <p className="mt-2 text-white/60 text-sm">
                  Set an alarm that only ends when you tap your phone to the brick. No snooze, no
                  scrolling.
                </p>
                <div className="mt-5 flex items-center gap-3">
                  <div className="font-display text-4xl tracking-tighter">06:30</div>
                  <span className="text-xs uppercase tracking-[0.2em] text-white/50">Mon–Fri</span>
                </div>
              </div>
          ...
          >
            ...
            <p className="mt-2 text-white/60 text-sm">
              Earn streaks for consecutive focus days. Unlock badges as your session totals grow.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-white/60 text-sm">
              Lockin defends itself. While you&apos;re bricked, the app can&apos;t be uninstalled and
              permissions can&apos;t be tampered with.
            </p>
          </div>
          ...
          >
            ...
            <h3 className="font-display text-2xl font-medium">Emergency unbrick</h3>
            <p className="mt-2 text-white/60 text-sm">
              Five lifetime escape hatches for true emergencies. Separate alarm credits keep mornings
              safe.
            </p>
            <div className="mt-5 flex items-center gap-1.5">
              {[0, 1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className={`h-1.5 flex-1 rounded-full ${i < 4 ? "bg-emerald-400" : "bg-white/15"}`}
                />
              ))}
