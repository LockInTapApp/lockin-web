...
export function FAQ() {
  return (
    <section id="faq" data-testid="faq-section" className="relative py-20 md:py-28 bg-white">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <Accordion type="single" collapsible className="mt-10 reveal" data-testid="faq-accordion">
          {FAQS.map((f, i) => (
            <AccordionItem
              key={i}
              value={`item-${i}`}
